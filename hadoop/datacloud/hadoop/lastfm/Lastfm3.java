...
public class Lastfm3 {
	...
	public static class LastfmMapper1
			extends Mapper<LongWritable, Text, Text, Text> {
		public void map(LongWritable key, Text value, Context context)
				throws IOException, InterruptedException {
			String[] data = value.toString().split("\t");

			context.write(new Text(data[0]), new Text(data[1] + " 0 0"));
		}
	}

	public static class LastfmMapper2
			extends Mapper<LongWritable, Text, Text, Text> {
	...
	public static class LastfmReducer extends Reducer<Text, Text, Text, Text> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			for (Text t : values) {
				...
				totalListeners += Integer.parseInt(data[0]);
				totalListening += Integer.parseInt(data[1]);
				totalSkip += Integer.parseInt(data[2]);
			}

			context.write(key, new Text(
					totalListeners + " " + totalListening + " " + totalSkip));
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(Lastfm3.class);
		...
		MultipleInputs.addInputPath(job,
				new Path("/outputlastfm1/part-r-00000"), TextInputFormat.class,
				LastfmMapper1.class);
		MultipleInputs.addInputPath(job,
				new Path("/outputlastfm2/part-r-00000"), TextInputFormat.class,
				LastfmMapper2.class);
